...
//if((boolean) vw_have_message()==NULL){ Serial.println("nada"); }
...
analogWrite(PinForward_1,0);
analogWrite(PinBackward_1,0);

analogWrite(PinForward_2, 0);
analogWrite(PinBackward_2,0);
